	    ...
	    <td style='padding-left:3px;padding-top:8px' valign="top">
	      ...
	      <dl class='bitem'>
	        ...
	        <dd style='display:block' class='sitem' id='items3_1'>
	          <ul class='sitemu'>
                 <li><a href='<%=path %>/admin/catelog/catelogAdd.jsp' target='main'>书籍类别添加</a> </li>
                 <li><a href='<%=path %>/catelog?type=catelogMana' target='main'>书籍类别管理</a> </li>
	          </ul>
	        </dd>
	      </dl>
	      <dl class='bitem'>
	        <dt onClick='showHide("items4_1")'><b>书籍信息管理</b></dt>
	        <dd style='display:block' class='sitem' id='items4_1'>
	          <ul class='sitemu'>
	              <li><a href='<%=path %>/zichan?type=zichanToAdd' target='main'>书籍资产添加</a></li>
	              <li><a href='<%=path %>/zichan?type=zichanMana' target='main'>书籍资产分析</a></li>
	          </ul>
	        </dd>
	      </dl>
	      <dl class='bitem'>
